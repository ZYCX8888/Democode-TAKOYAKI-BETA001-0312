...
static unsigned char _af_linear2alaw(short pcm_val)
{
    short mask=0x00;
    short seg=0x00;
...
static  short _af_alaw2linear( unsigned char a_val)
{
    short t;
    short seg;
...
static unsigned char _af_linear2ulaw (short pcm_val)
{
    short mask;
    short seg;
    unsigned char uval;
...
static short _af_ulaw2linear (unsigned char u_val)
{
