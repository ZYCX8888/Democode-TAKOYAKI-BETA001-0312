...
#ifndef _MID_UVC_DATATYPE_H_
#define _MID_UVC_DATATYPE_H_
...
typedef struct MI_UVC_BufInfo_s {
...
typedef struct MI_UVC_USERPTR_BufOpts_s {
    MI_S32  (* UVC_DevFillBuffer)(void *uvc,MI_UVC_BufInfo_t *bufInfo);
} MI_UVC_USERPTR_BufOpts_t;

typedef struct MI_UVC_MMAP_BufOpts_s {
    MI_S32  (* UVC_DevFillBuffer)(void *uvc,MI_UVC_BufInfo_t *bufInfo);
} MI_UVC_MMAP_BufOpts_t;

typedef struct MI_UVC_OPS_s {
    MI_S32  (* UVC_Inputdev_Init)  (void *uvc);
    MI_S32  (* UVC_Inputdev_Deinit)(void *uvc);
    union {
        MI_UVC_MMAP_BufOpts_t m;
        MI_UVC_USERPTR_BufOpts_t u;
    };
