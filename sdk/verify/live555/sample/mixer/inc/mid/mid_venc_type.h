...
typedef struct _VencRoi_t
{
    ...
    MI_U32  mbX;       //nCbX, nCbY是ROI的left-top-position in CB unit. Default: nCbX=0, nCbY=0
    MI_U32  mbY;
    MI_U32  mbW;       //nCbW, nCbH是ROI的width,height in CB unit. Default: nCbW =0, nCbH =0
    MI_U32  mbH;
} VencRoi_t;
...
typedef struct _VencH264SliceSplit_t
{
    ...
    MI_U32  bits;  //0 ~ (2^16 – 1), Default: 0; Bit-mode indicates bits-size of a coded-slice, nBits = 0 indicates bit-mode is disabled.
