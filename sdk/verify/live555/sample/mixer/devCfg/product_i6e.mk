...
ifeq ($(HARDWARE_VERSION), U01)
M_STREAM_FROM_PORT ?= 1
S_STREAM_FROM_PORT ?= 2
T_STREAM_FROM_PORT ?= 2
J_STREAM_FROM_PORT ?= 0
O_STREAM_FROM_PORT ?= 2
OPEN_LDC_FROM_PORT ?= 1
J_VENC_BIND_TYPE ?= 1
else ifeq ($(HARDWARE_VERSION), U02)
M_STREAM_FROM_PORT ?= 0
S_STREAM_FROM_PORT ?= 2
T_STREAM_FROM_PORT ?= 2
J_STREAM_FROM_PORT ?= 1
O_STREAM_FROM_PORT ?= 2
OPEN_LDC_FROM_PORT ?= 1
J_VENC_BIND_TYPE ?= 1
endif
...
M_STREAM_MAX_BITRATE ?= 16000000
M_STREAM_MIN_BITRATE ?= 512000
M_STREAM_CUR_BITRATE ?= 4000000

S_STREAM_MAX_BITRATE ?= 4000000
S_STREAM_MIN_BITRATE ?= 128000
S_STREAM_CUR_BITRATE ?= 2000000

T_STREAM_MAX_BITRATE ?= 4000000
T_STREAM_MIN_BITRATE ?= 128000
T_STREAM_CUR_BITRATE ?= 1000000
...
D_FLAGS += -D OPEN_LDC_FROM_PORT=$(OPEN_LDC_FROM_PORT)
