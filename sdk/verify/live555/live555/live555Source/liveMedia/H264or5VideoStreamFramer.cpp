...
double H264or5VideoStreamFramer::defaultFrameRate = 30.0; //by default
...
::H264or5VideoStreamFramer(int hNumber, UsageEnvironment& env, FramedSource* inputSource,
  ...
  //fFrameRate = inputSource->miFrameRate; // We assume a frame rate of 25 fps, unless we learn otherwise (from parsing a VPS or SPS NAL unit)
  //printf("\nH264or5VideoStreamFramer fFrameRate = %lf %x\n", fFrameRate, inputSource);
