...
#define	__BASE_TYPES_H
	...
	//typedef int BOOL;
        ...
        // typedef signed char BOOL; // REMARK by Tai, 2014/11/27
    #else
        typedef int BOOL;
    #endif
	typedef void VOID;
...
enum
{
	...
	VSR_LANG_MANDARIN_NAN,		//	BSR_LANG_34, Taiwan min nan.»Ô«n»y	2010/05/12 
	VSR_LANG_VIETNAMESE_VIE,	//	BSR_LANG_35, VIETNAM VIETNAMESE.    2010/11/11
	VSR_LANG_MAX				//	Max 2009/04/21
}; //Last update: TMN 2010/05/12
