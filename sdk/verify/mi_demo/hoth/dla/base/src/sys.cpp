...
void Sys::CreateConnection()
{
    ...
    connectIdMap["RTSP"] = E_SYS_MOD_RTSP;
    connectIdMap["VENC"] = E_SYS_MOD_VENC;
    connectIdMap["VPE"] = E_SYS_MOD_VPE;
    connectIdMap["DIVP"] = E_SYS_MOD_DIVP;
    connectIdMap["DISP"] = E_SYS_MOD_DISP;
    connectIdMap["VDEC"] = E_SYS_MOD_VDEC;
    connectIdMap["VIF"] = E_SYS_MOD_VIF;
    connectIdMap["VDISP"] = E_SYS_MOD_VDISP;
    connectIdMap["LDC"] = E_SYS_MOD_LDC;
    connectIdMap["DLA"] = E_SYS_MOD_DLA;
    connectIdMap["FDFR"] = E_SYS_MOD_FDFR;
    connectIdMap["UI"] = E_SYS_MOD_UI;
    connectIdMap["IQ"] = E_SYS_MOD_IQ;
    connectIdMap["FILE"] = E_SYS_MOD_FILE;
