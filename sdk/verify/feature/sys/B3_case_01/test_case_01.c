...
static MI_S32 STUB_BaseModuleInit(void)
{
    ...
    *************************************************/
    ...
    /************************************************
    Step6:  Bind src(devId, chnId, portId) -> dst(devId, chnId, portId)
    *************************************************/
...
static MI_S32 STUB_BaseModuleDeinit(void)
{
    ...
    //unbind: divp(0, 0, 0)-x->venc(0, 2, 0)
    u32DivpDevId = 0;
    u32DivpChnId = 0;
    u32DivpPortId = 0;
    u32VencDevId = 0;
    ...
    //unbind: divp(0, 1, 0)-x->venc(0, 3, 0)
    u32DivpDevId = 0;
    u32DivpChnId = 1;
    u32DivpPortId = 0;
    u32VencDevId = 0;
