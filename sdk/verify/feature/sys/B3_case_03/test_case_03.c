...
static MI_S32 STUB_BaseModuleInit(void)
{
    ...
    *************************************************/
    ...
    //bind vpe(0, 0, 2)->divp(0, 2..3, 0), divp(0, 2..3, 0)->venc(0, 2..3, 0)
    u32DivpDevId = 0;
    u32DivpPortId = 0;
    u32VpeDevId = 0;
    u32VpeChnId = 0;
    u32VencDevId = 0;
    u32VencPortId = 0;
    for(u32Index=0; u32Index<STUB_VENC_CHN_NUM; ++u32Index)
    {
        u32VpePortId = (u32Index>=STUB_VPE_OUTPUT_PORT_NUM)? STUB_VPE_OUTPUT_PORT_NUM-1 : u32Index;
...
static MI_S32 STUB_BaseModuleDeinit(void)
{
    ...
    //unbind: divp(0, 0..3, 0)-x->venc(0, 0..3, 0) vif(0, 0..3, 0)-x->divp(0, 0..3, 0)
    u32VpeDevId = 0;
    u32VpeChnId = 0;
    u32DivpDevId = 0;
    u32DivpPortId = 0;
