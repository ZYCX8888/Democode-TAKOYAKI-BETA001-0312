...
/*
* Notice: because vpe cannot support frame mode in and have no two vif channel, so cannot test this item!!!
*/
...
#define STUB_VIF_CHN_NUM 2
#define STUB_VPE_CHN_NUM 2
#define STUB_DIVP_CHN_NUM 2
#define STUB_VENC_CHN_NUM 2


static STUB_VencRes_t _stStubVencRes[STUB_VENC_CHN_NUM];

STUB_Resolution_t _stVifResolution[2] =
{
    {1920, 1080, 1920, 1080},
    {1920, 1080, 1920, 1080}
};

STUB_Resolution_t _stVpeResolution[STUB_VPE_CHN_NUM] =
{
    {1920, 1080, 1920, 1080},
    {704, 576, 640, 480}
};
...
static MI_S32 STUB_BaseModuleInit(void)
{
    ...
    *************************************************/
    u32VpeDevId = 0;
    u32VpePortId = 0;
    for(u32VpeChnId=0; u32VpeChnId<STUB_VPE_CHN_NUM; ++u32VpeChnId)
    {
...
static MI_S32 STUB_BaseModuleDeinit(void)
{
    ...
    u32VifDevId = 0;
    u32VifPortId = 0;
    for(u32VifChnId=0; u32VifChnId<STUB_VIF_CHN_NUM; ++u32VifChnId)
    {
