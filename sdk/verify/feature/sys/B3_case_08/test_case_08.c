...
static MI_S32 STUB_BaseModuleInit(void)
{
    ...
    *************************************************/
    ...
    for(u32VencChnId=0; u32VencChnId<STUB_VENC_CHN_NUM; ++u32VencChnId)
    {
        ...
        else
        {
            ...
            stVencChnAttr.stVeAttr.stAttrJpeg.u32MaxPicWidth = _stVencResolution[u32VencChnId].u32MaxWidth;
            stVencChnAttr.stVeAttr.stAttrJpeg.u32MaxPicHeight = _stVencResolution[u32VencChnId].u32MaxHeight;
            stVencChnAttr.stVeAttr.stAttrJpeg.u32PicWidth = _stVencResolution[u32VencChnId].u32OutWidth;
            stVencChnAttr.stVeAttr.stAttrJpeg.u32PicHeight = _stVencResolution[u32VencChnId].u32OutHeight;
    ...
    *************************************************/
    ...
    //bind vpe(0, 0, 0)->venc(1, 0, 0) jpeg imi
    u32VpeDevId = 0;
    u32VpeChnId = 0;
    u32VpePortId = 0;
    u32VencChnId = 0;
    ...
    //bind vpe(0, 0, 1..2)->divp(0, 0..1, 0), divp(0, 0..1, 0)->venc(0, 1..2, 0)
    u32DivpDevId = 0;
    u32DivpPortId = 0;
    u32VpeDevId = 0;
    u32VpeChnId = 0;
    ...
    {
        u32VpePortId = u32Index + 1;
        u32DivpChnId = u32Index;
        u32VencChnId = u32Index + 1;
        STCHECKRESULT(MI_VENC_GetChnDevid(u32VencChnId, &u32VencDevId));

        //bind vpe(0, 0, 1..2)->divp(0, 0..1, 0)
        memset(&stSrcChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        memset(&stDstChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        stSrcChnPort.eModId = E_MI_MODULE_ID_VPE;
        stSrcChnPort.u32DevId = u32VpeDevId;
        ...
        //bind divp(0, 0..1, 0)->venc(0, 1..2, 0)
        memset(&stSrcChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        memset(&stDstChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
...
static MI_S32 STUB_BaseModuleDeinit(void)
{
    ...
    //unbind: divp(0, 0..1, 0)-x->venc(0, 1..2, 0) vpe(0, 1..2, 0)-x->divp(0, 0..1, 0)
    u32VpeDevId = 0;
    u32VpeChnId = 0;
    u32DivpDevId = 0;
    u32DivpPortId = 0;
    ...
    for(u32Index=0; u32Index<STUB_DIVP_CHN_NUM; ++u32Index)
    {
        ...
        //unbind divp(0, 0..1, 0)->venc(0, 1..2, 0)
        memset(&stSrcChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        memset(&stDstChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        stSrcChnPort.eModId = E_MI_MODULE_ID_DIVP;
        stSrcChnPort.u32DevId = u32DivpDevId;
        ...
        //unbind vpe(0, 0, 1..2)->divp(0, 0..1, 0)
        memset(&stSrcChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        memset(&stDstChnPort, 0x0, sizeof(MI_SYS_ChnPort_t));
        stSrcChnPort.eModId = E_MI_MODULE_ID_VPE;
        stSrcChnPort.u32DevId = u32VpeDevId;
