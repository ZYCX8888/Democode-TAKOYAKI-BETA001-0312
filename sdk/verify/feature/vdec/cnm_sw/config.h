...
#define SUPPORT_MEMORY_SIZE_OPTIMIZE // ae32000.vct(linker script) also should be modified for WAVE5_MAX_CODE_BUF_SIZE
#define FIX_SIGCHA_56
// #define SUPPORT_SG_FLOW // for sigmastar software flow
// #define SUPPORT_SG_FR_FLOW // for 1 fps test
#define SUPPORT_RECOVER_AFTER_ERROR
#define USE_DROP_LARGE_CHUNK_THAN_BSSIZE
#endif /* __CONFIG_H__ */
