...
#define WIDTH 3840
#define HEIGHT 2160
#define PIXEL E_MI_SYS_PIXEL_FRAME_RGB_BAYER_12BPP_BG
#else
#define WIDTH 1920
#define HEIGHT 1080
#define PIXEL E_MI_SYS_PIXEL_FRAME_RGB_BAYER_12BPP_RG
#endif
...
static MI_S32 St_BaseModuleInit(Test_Parames_t     *pstParamer)
{
    ...
    stVifPortInfoInfo.u32RectWidth = WIDTH;
    stVifPortInfoInfo.u32RectHeight = HEIGHT;
    stVifPortInfoInfo.u32DestWidth = WIDTH;
    stVifPortInfoInfo.u32DestHeight = HEIGHT;
    stVifPortInfoInfo.ePixFormat = PIXEL;
    ...
    Step4:  init VPE top
    *************************************************/
    stVpeChannelInfo.u16VpeMaxW = WIDTH;
    stVpeChannelInfo.u16VpeMaxH = HEIGHT;
    ...
    stVpeChannelInfo.bRot = TRUE;
    stVpeChannelInfo.eFormat = PIXEL;
    ...
    stPortInfo.u16OutputWidth = WIDTH;
    stPortInfo.u16OutputHeight = HEIGHT;
    ...
    *************************************************/
    ...
    MI_VPE_SetChannelRotation(1, pstParamer->eRot);
    ...
    printf("vpeBottom port%d, (%dx%d), pixel %d, runmode %d, rot %d\n", 0, stPortInfo.u16OutputWidth, 
        stPortInfo.u16OutputHeight, stPortInfo.ePixelFormat, stVpeChannelInfo.eRunningMode, pstParamer->eRot);
...
int checkParame(Test_Parames_t     *pstParamer)
{
    ...
    MI_SYS_Rotate_e eRot = pstParamer->eRot;
    ...
    if(eRot > E_MI_SYS_ROTATE_270)
    {
        printf("Rot %d err \n", eRot);
        pstParamer->eRot = E_MI_SYS_ROTATE_90;
    }
...
MI_S32 main(int argc, char **argv)
{
    ...
    if(argc < 8)
    {
       ...
       printf("portid[1], width[2], height[3], pixel[4](YUV422:0, YUV420:10, ARGB8888:1, ABGR8888:2, BGRA8888:3),Rot[5], filepath[6], cnt[7]\n");
       return 1;
    }
    ...
    stParamer.eRot = atoi(argv[5]);
    stParamer.pDestFile = argv[6];
    stParamer.cnt = atoi(argv[7]);

    printf("portid %d, width %d, height %d, pixel %d, Rot %d, filename %s, cnt %d\n", stParamer.u16PortId, 
        stParamer.u16Width, stParamer.u16Height,stParamer.ePixelFormat, stParamer.eRot, stParamer.pDestFile,stParamer.cnt);
