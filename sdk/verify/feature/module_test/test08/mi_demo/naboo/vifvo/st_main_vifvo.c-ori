...
ST_CaseDesc_t g_stVifCaseDesc[] =
{
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 18,
            .szDesc = "AD0-1x1080P Video Capture 1xPreview+4xH264+2xH265",
            .u32WndNum = 1,
            .u32VencNum = 6,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 27,
            .szDesc = "AD 8x1080P Double Edge 2Mux, 9xVENC + 8xVDEC",
            .u32WndNum = 8,
            .bNeedVdisp = TRUE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 28,
            .szDesc = "AD 8x1080P Double Edge 2Mux, 8xVENC(Main+Sub)",
            .u32WndNum = 8,
            // .bNeedVdisp = TRUE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    for (i = 0; i < s32CapChnNum; i++)
    {
        ...
        */
        ...
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_SUB_CHN)
        {
            ...
            {
                stPortInfo.u16OutputWidth =
                    ALIGN_N(pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapWidth / 2, VENC_H265_ALIGN_W);
                stPortInfo.u16OutputHeight =
                    ALIGN_N(pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight / 2, VENC_H265_ALIGN_H);
            }
            else
            {
                stPortInfo.u16OutputWidth =
                    ALIGN_N(pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapWidth / 2, 32);
                stPortInfo.u16OutputHeight =
                    ALIGN_N(pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight / 2, 32);
            }
    ...
    *************************************************/
    ...
    for (i = 0; i < u32VencNum; i ++)
    {
        ...
        if (E_MI_VENC_MODTYPE_H264E == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.eType)
        {
            ...
            stChnAttr.stRcAttr.stAttrH264Cbr.u32SrcFrmRateDen = 25;
            stChnAttr.stRcAttr.stAttrH264Cbr.u32FluctuateLevel = 0;
            #endif
        }
        else if (E_MI_VENC_MODTYPE_H265E == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.eType)
