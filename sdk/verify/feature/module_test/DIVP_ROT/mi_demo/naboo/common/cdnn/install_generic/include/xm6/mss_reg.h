...
/**
@file mss_reg.h
@brief CEVA-XM6 MSS (Memory Sub-System) driver register map
*/
...
typedef enum
{
	...
	MSS_DMSS_DMBA_ADDR              = 0x600,      /**< DMSS Data Memory Base Address Register*/
	MSS_DMSS_DMBE_ADDR              = 0x604,      /**< DMSS Data Memory Status Register*/
	MSS_DMSS_HDCFG_ADDR             = 0x61C,      /**< DMSS Hardware Memory Configuration Register*/
	MSS_DMSS_DACC_ADDR              = 0x628,      /**< DMSS DMA Outstanding Configuration Register*/
	MSS_DMSS_SDCFG_ADDR             = 0x62C,      /**< DMSS SDCFG Register*/
	MSS_DMSS_2DCFG1_ADDR            = 0x660,      /**< DMSS 2D Memory Configuration First Register*/
	MSS_DMSS_2DCFG2_ADDR            = 0x664,      /**< DMSS 2D Memory Configuration Second Register*/
	MSS_DMSS_2DCFG3_ADDR            = 0x668,      /**< DMSS 2D Memory Configuration 3rd Register*/
    MSS_DMSS_2DCFG4_ADDR            = 0x66c,      /**< DMSS 2D Memory Configuration 4th Register*/
    MSS_DMSS_2DCFG5_ADDR            = 0x670,      /**< DMSS 2D Memory Configuration 5th Register*/
    MSS_DMSS_2DCFG6_ADDR            = 0x674,      /**< DMSS 2D Memory Configuration 6th Register*/
	...
	MSS_IC_ADD_START_BASE_ADDR      = 0x920,      /**< Memory Region Start Address Base Register*/
	MSS_IC_ADD_ATT0_BASE_ADDR       = 0x924,      /**< Memory Region Attribute 0 Base Register*/
	MSS_IC_ADD_ATT1_BASE_ADDR       = 0x928,      /**< Memory Region Attribute 1 Base Register*/
	
	MSS_WD_SYSTIML_ADDR             = 0x710,      /**< WD MSS System Clock lower part Register*/
	MSS_WD_SYSTIMH_ADDR             = 0x714       /**< WD MSS System Clock upper part Register*/
}   mss_regs_addr_e;
...
typedef union {
	struct {
        ...
        - 4: PMSS TCM retention indication
        - 5: PMSS cache and tag retention indication
        - 6: DMSS block 0 retention indication
        - 7: DMSS block 1 retention indication
        - 8: DMSS block 2 retention indication
        - 9: DMSS block 3 retention indication
        - 10: Reserved
        - 11: Reserved
        - 12: Reserved
        - 13: Reserved
        - 14: Reserved
        - 15: BTB (Branch Target Buffer) retention indication
        This field is only present if the PSU Power Gating is set.
        @note RET is read/write by external masters and read only by the core. The core sets the RET field with psu {deepsleep}. */
	    unsigned mem_retention : 12;
	    
        /**
	    Shutdown Indications bus.
        When clear, indicates that the physical memory is in Shutdown (no voltage is supplied):
        - 16: Core and MSS shutdown indication
        - 17: OCEM and RTT shutdown indication
        - 18: PMSS TCM shutdown indication
        - 19: PMSS cache shutdown indication
        - 20: DMSS block 0 shutdown indication
        - 21: DMSS block 1 shutdown indication
        - 22: DMSS block 2 shutdown indication
        - 23: DMSS block 3 shutdown indication
        - 24: Reserved
        - 25: Reserved
        - 26: Reserved
        - 27: Reserved
        - 28: Reserved
        - 29: BTB (Branch Target Buffer) retention indication
        This field is only present if the PSU Power Gating is set.
        @note SHTDWN is read/write by external masters and read only by the core. The core sets the PMOD field with psu {shutdown}. */
	    unsigned shutdown : 14;
...
typedef union {
	struct {
        ...
        unsigned dpraw : 1;                /**< Data protection RAW / SO indication for this memory region. 
                                                This bit should not be modified during AXI write or read transfers. */
