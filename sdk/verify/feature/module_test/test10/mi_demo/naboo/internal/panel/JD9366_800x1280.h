...
{
    "sato800x1280",    //const char *pPanelName; ///<  PanelName
    ...
    488,       //u16 u16HSyncBackPorch;           ///<  Hsync back porch

    6,       //u16 u16VSyncWidth;               ///<  Vsync width
    ...
    E_MI_PNL_CH_SWAP_2,//E_MI_PNL_CH_SWAP_4,
    E_MI_PNL_CH_SWAP_4,//E_MI_PNL_CH_SWAP_3,
    E_MI_PNL_CH_SWAP_3,//E_MI_PNL_CH_SWAP_2,
    E_MI_PNL_CH_SWAP_1,//E_MI_PNL_CH_SWAP_1,
    E_MI_PNL_CH_SWAP_0,//E_MI_PNL_CH_SWAP_0,
};
...
const MI_PANEL_MipiDsiConfig_t astMipiDsiConfig[]=
{
    [Sync_Pulse_RGB888] = {
        ...
        //800,  18,    18,  18,   1280, 4,   20,   10,   0,    60,
        ...
        E_MI_PNL_MIPI_DSI_SYNC_PULSE,//E_MI_PNL_MIPI_DSI_SYNC_PULSE,  // MIPnlMipiDsiCtrlMode_e enCtrl;
