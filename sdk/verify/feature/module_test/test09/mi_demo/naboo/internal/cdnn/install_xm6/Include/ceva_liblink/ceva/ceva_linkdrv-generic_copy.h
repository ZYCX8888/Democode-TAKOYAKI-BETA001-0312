 ...
 */
#define CEVA_PCIDEV_DEVICE_NAME                             "ceva_linkdrv_pci"
/*!
 * dma region size
 */
#define CEVADEV_PCI_DMA_MEM_SIZE                                (1024*1024*16)
/*!
 * kfifo max size
 */
...
#define IOC_CEVADRV_READ_DEBUG       _IOWR(IOC_CEVADRV_MAGIC,  3, \
		union ceva_linkdrv_debug_info)
#define IOC_CEVADRV_GENERATE_INT     _IOW(IOC_CEVADRV_MAGIC,   4, int)
#define IOC_CEVADRV_GET_PID_PROCID   _IOR(IOC_CEVADRV_MAGIC,   5, \
		unsigned long)

#define IOC_CEVADRV_MAXNR            5
