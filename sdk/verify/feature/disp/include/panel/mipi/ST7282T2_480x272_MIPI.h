#ifndef _ST7282T2_480x272_H
#define _ST7282T2_480x272_H
...
{
    "ST7282T2_480x272",    //const char *pPanelName; ///<  PanelName
    ...
    338,       //u16 u16HSyncBackPorch;           ///<  Hsync back porch

    4,       //u16 u16VSyncWidth;               ///<  Vsync width
    1018,      //u16 u16VSyncBackPorch;           ///<  Vsync back porch
